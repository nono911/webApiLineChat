...
var FlexMessage = require('./linebot/message/flex.message');
...
function Bot (client, options) {
  ...
  this.replyFlexMessage = function(replyToken, messageBuilder) {
    return client.post(endpointBase + '/' + version + '/bot/message/reply', {
      replyToken: replyToken,
      messages: messageBuilder.buildMessage()
    });
  ...
  this.pushFlexMessage = function(to, messageBuilder) {
    return client.post(endpointBase + '/' + version + '/bot/message/push', {
      to: to,
      messages: messageBuilder.buildMessage()
    });
